...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Image runat="server" ImageUrl="~/Content/Images/roomc4.jpg" AlternateText="roomc1" style="width: 100%; height: 30%; text-align: center;" CssClass="image-class1" />
    <div class="content-area">
        ...
        <h5 style="margin-top: 20px;">粉藍房間溫馨舒適、乾淨明亮空間，客房空間寬敞，</h5>
        <h5>透過巧思、精心雅緻佈景，呈現溫馨別致的公主房，住起來舒適自在。</h5>
    </div>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="/Content/Images/roomc1.jpg" class="d-block w-75" alt="..." style="display: block; margin: 0 auto;">
    </div>
    <div class="carousel-item">
      <img src="/Content/Images/roomc2.jpg" class="d-block w-75" alt="..." style="display: block; margin: 0 auto;">
    </div>
    <div class="carousel-item">
      <img src="/Content/Images/roomc3.jpg" class="d-block w-75" alt="..." style="display: block; margin: 0 auto;">
    </div>
    <div class="carousel-item">
      <img src="/Content/Images/roomc4.jpg" class="d-block w-75" alt="..." style="display: block; margin: 0 auto;">
    </div>
