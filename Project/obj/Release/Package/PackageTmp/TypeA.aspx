...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Image runat="server" ImageUrl="~/Content/Images/rooma1.jpg" AlternateText="rooma1" style="width:100%; height: 30%; text-align: center;" CssClass="image-class1" />
    <div class="content-area">
        ...
        <h5 style="margin-top: 20px;">以簡約、細緻為客房設計主概念，房內以橘棕色為主色，搭配溫暖柔和的光線，...</h5>
    </div>  
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" style="margin-top: 30px;">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="/Content/Images/rooma1.jpg" class="d-block w-75" alt="..." style="display: block; margin: 0 auto;">
        </div>
        <div class="carousel-item">
          <img src="/Content/Images/rooma2.jpg" class="d-block w-75" alt="..." style="display: block; margin: 0 auto;">
        </div>
        <div class="carousel-item">
          <img src="/Content/Images/rooma3.jpg" class="d-block w-75" alt="..." style="display: block; margin: 0 auto;">
        </div>
        <div class="carousel-item">
          <img src="/Content/Images/rooma4.jpg" class="d-block w-75" alt="..." style="display: block; margin: 0 auto;">
        </div>
        <div class="carousel-item">
          <img src="/Content/Images/rooma5.jpg" class="d-block w-75" alt="..." style="display: block; margin: 0 auto;">
        </div>
      </div>
