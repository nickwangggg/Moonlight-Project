...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Image runat="server" ImageUrl="~/Content/Images/roomb1.jpg" AlternateText="roomb1" style="width: 100%; height: auto; text-align: center;" CssClass="image-class1" />
    <div class="content-area">
        ...
        <h5 style="margin-top: 20px;">簡約、細緻為客房設計主概念，房內以橘棕色為主色，搭配溫暖柔和的光線，</h5>
        <h5>無論是商務出差或度假出遊，皆能讓您洗淨一天的疲憊，享受難得的放鬆與悠閒。</h5>
    </div>
  ...
  <div class="carousel-indicators">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="/Content/Images/roomb1.jpg" class="d-block w-75" alt="..." style="display: block; margin: 0 auto;">
        </div>
        <div class="carousel-item">
          <img src="/Content/Images/roomb2.jpg" class="d-block w-75" alt="..." style="display: block; margin: 0 auto;">
        </div>
        <div class="carousel-item">
          <img src="/Content/Images/roomb3.jpg" class="d-block w-75" alt="..." style="display: block; margin: 0 auto;">
        </div>
        <div class="carousel-item">
          <img src="/Content/Images/roomb4.jpg" class="d-block w-75" alt="..." style="display: block; margin: 0 auto;">
        </div>
      </div>
